...
function saveSession(role, username){
  localStorage.setItem('app_session_mobile_teste', JSON.stringify({ role, username }));
}

function readSession(){
  return JSON.parse(localStorage.getItem('app_session_mobile_teste') || 'null');
}

function clearSession(){
  localStorage.removeItem('app_session_mobile_teste');
}
